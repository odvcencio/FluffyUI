...
// Package tcell provides a stub Backend implementation for WASM builds.
// The tcell backend is not supported in browsers; use the wasm backend instead.
package tcell
...
var errNotSupported = errors.New("tcell backend not supported on WASM")
