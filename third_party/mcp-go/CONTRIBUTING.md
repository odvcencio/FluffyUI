...
Make sure you have Go 1.22 or later installed on your machine. You can check your Go version by running:
...
Feel free to reach out if you have any questions or need help either by [opening an issue](https://github.com/odvcencio/fluffyui/third_party/mcp-go/issues) or by reaching out in the [Discord channel](https://discord.gg/RqSS2NQVsY).
