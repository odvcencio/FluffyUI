...
const (
	...
	// MethodResourcesSubscribe subscribes the client to resource updates.
	// https://modelcontextprotocol.io/specification/2025-03-26/server/resources#subscribe
	MethodResourcesSubscribe MCPMethod = "resources/subscribe"

	// MethodResourcesUnsubscribe unsubscribes the client from resource updates.
	// https://modelcontextprotocol.io/specification/2025-03-26/server/resources#subscribe
...
// AuthParams carries authentication information for transports without HTTP headers.
