...
func (s *InProcessSession) NotificationQueue() chan mcp.JSONRPCNotification {
	return s.notifications
}

func (s *InProcessSession) Close() error {
	return nil
}
...
var (
	...
	_ SessionWithNotificationQueue = (*InProcessSession)(nil)
	_ SessionCloser                = (*InProcessSession)(nil)
)
